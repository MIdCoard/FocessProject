    ...
    private void func_192740_f()
    {
        if (this.field_192757_e.isFile())
        {
            try
            {
                ...
                Map<ResourceLocation, AdvancementProgress> map = (Map<ResourceLocation, AdvancementProgress>)JsonUtils.func_193840_a(field_192754_b, s, field_192755_c.getType());
                ...
                for (Entry<ResourceLocation, AdvancementProgress> entry : (List<Entry<ResourceLocation, AdvancementProgress>>)stream.collect(Collectors.toList()))
                {
            ...
            for (Entry<String, Criterion> entry : p_193764_1_.func_192073_f().entrySet())
            {
                ...
                if (criterionprogress != null && !criterionprogress.func_192151_a())
                {
                    ...
                    if (icriterioninstance != null)
                    {
                        ...
                        {
                            icriteriontrigger.func_192165_a(this, new ICriterionTrigger.Listener<ICriterionInstance>(icriterioninstance, p_193764_1_, (String)entry.getKey()));
                        }
                    }
                }
            }
        ...
        for (Entry<String, Criterion> entry : p_193765_1_.func_192073_f().entrySet())
        {
            ...
            if (criterionprogress != null && (criterionprogress.func_192151_a() || advancementprogress.func_192105_a()))
            {
                ...
                if (icriterioninstance != null)
                {
                    ...
                    if (icriteriontrigger != null)
                    {
                        icriteriontrigger.func_192164_b(this, new ICriterionTrigger.Listener<ICriterionInstance>(icriterioninstance, p_193765_1_, (String)entry.getKey()));
                    }
                }
            }
        }
