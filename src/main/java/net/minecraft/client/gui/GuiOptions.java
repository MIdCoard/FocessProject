...
import com.focess.GuiScreenFocessPlugins;
...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(300, this.width / 2 - 155, this.height / 6 + 144 - 6, 150, 20, "Focess Plugins"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if (button.id == 300) {
            	this.mc.gameSettings.saveOptions();
            	this.mc.displayGuiScreen(new GuiScreenFocessPlugins(this));
            }
        }
    }
